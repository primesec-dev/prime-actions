...
class TestPostReviewComments:
    def test_posts_comment_for_each_finding(self, pr_context: PRContext) -> None:
        findings = [
    ...
    def test_empty_findings_posts_nothing(self, pr_context: PRContext) -> None:
        with patch("prime_actions.commenter.create_review_comment") as mock_create:
    ...
    def test_continues_on_api_error(self, pr_context: PRContext) -> None:
        findings = [
